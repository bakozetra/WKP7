...
var aboutBook = document.querySelector('.aboutBook');
var addButton = document.querySelector('.btnadd');

var aboutBooks = function aboutBooks() {
  var detailBook = books.map(function (book) {
...
console.log(aboutBooks()); // function of add button

var inputBook = function inputBook() {
  console.log('hi');
}; // event llistener


window.addEventListener('click', inputBook);
